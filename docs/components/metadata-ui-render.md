---
title: metadata-ui-render 元数据渲染组件
nav: 组件
toc: content
group:
  title: 业务组件
...
# @jusda-tools/metadata-ui-render

## 技术中台元数据渲染组件

### 扩展字段搜索功能 demo

<code iframe="true" src="../../demo/metadata-ui-render/ExtensionalQueryForm.jsx"></code>
...
<code iframe="true" src="../../demo/metadata-ui-render/CustomAreaFormRender.jsx"></code>
...
获取列表功能中配置的标准字段和扩展字段列表，并添加字段标识及字段显示名配置，按照 sequence 属性升序排序
...
#### MetadataRender (v1.4.0版本移除)

#### 代码演示

```jsx | pure
import React from 'react';
import MetadataRender, {useForm} from '@jusda-tools/metadata-ui-render';
...
#### MetadataContextProvider  (v1.4.0版本移除)
...
#### getTenantModalUIMetadata  (v1.4.0版本移除)
...
#### getTenantModelConfiguration  (v1.4.0版本移除)
