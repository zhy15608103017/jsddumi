...
export const ICON_CODE = {
  ...
  export const ICON_TIMESTR = {
    ...
    SST_ETA: [language["JusdaWaybillList.预计到达提货地"], language["JusdaWaybillList.实际到达提货地时间"]],
    SST_LPP: [language["JusdaWaybillList.预计离开提货地时间"],language["JusdaWaybillList.实际离开提货地时间"]],
