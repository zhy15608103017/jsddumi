...
if (!Object.keys) Object.keys = function () {
    var t = Object.prototype.hasOwnProperty,
        ...
        r = ['toString', 'toLocaleString', 'valueOf', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable',
            'constructor'],
        i = r.length;
    return function (n) {
        if (typeof n !== 'object' && typeof n !== 'function' || n === null) throw new TypeError(
...
if (!Date.prototype.toISOString) Date.prototype.toISOString = function () {
    ...
    return function e() {
        ...
        return [r, t(this.getUTCMonth() + 1), t(this.getUTCDate())].join('-') + 'T' + [t(this.getUTCHours()), t(
            this.getUTCMinutes()), t(this.getUTCSeconds())].join(':') + '.' + t(this.getUTCMilliseconds(),
            3) + 'Z';
    };
}();
